...
android {
    ...
    buildTypes {
        ...
        val map:Map<String,Any> = mutableMapOf("MAPS_API_KEY" to properties.getProperty("MAPS_API_KEY"))
        android.defaultConfig.manifestPlaceholders(map)

        debug {
            buildConfigField("String", "MAP_API_KEY", "\"${properties.getProperty("MAPS_API_KEY")}\"")
        }
        release {
